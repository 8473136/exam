...
public class ManagementPaperController {
    ...
    @TraceLog(module = "试卷管理", business = "发布试卷")
    public Integer releasePaper(@RequestBody ReleasePaperVO vo){
        return paperService.releasePaper(vo);
    }
}
